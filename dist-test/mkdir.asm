...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ed:	f7 f1                	div    %ecx
 3ef:	0f b6 92 90 07 00 00 	movzbl 0x790(%edx),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 577:	e9 06 ff ff ff       	jmp    482 <printf+0x45>
          s = "(null)";
 57c:	bb 87 07 00 00       	mov    $0x787,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 619:	a1 34 0a 00 00       	mov    0xa34,%eax
 ...
 628:	77 10                	ja     63a <free+0x2d>
{
 ...
 653:	89 08                	mov    %ecx,(%eax)
  freep = p;
 655:	a3 34 0a 00 00       	mov    %eax,0xa34
}
 65a:	5b                   	pop    %ebx
 65b:	5e                   	pop    %esi
 65c:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 68d:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 690:	8b 15 34 0a 00 00    	mov    0xa34,%edx
 ...
 6b8:	eb 70                	jmp    72a <malloc+0xaf>
    base.s.ptr = freep = prevp = &base;
 6ba:	c7 05 34 0a 00 00 38 	movl   $0xa38,0xa34
 6c1:	0a 00 00 
 6c4:	c7 05 38 0a 00 00 38 	movl   $0xa38,0xa38
 6cb:	0a 00 00 
    base.s.size = 0;
 6ce:	c7 05 3c 0a 00 00 00 	movl   $0x0,0xa3c
 6d5:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 6d8:	ba 38 0a 00 00       	mov    $0xa38,%edx
 ...
 6eb:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 6ee:	89 15 34 0a 00 00    	mov    %edx,0xa34
      return (void*)(p + 1);
 ...
 70f:	e8 f9 fe ff ff       	call   60d <free>
  return freep;
 714:	8b 15 34 0a 00 00    	mov    0xa34,%edx
      if((p = morecore(nunits)) == 0)
 ...
 72a:	89 c2                	mov    %eax,%edx
    if(p == freep)
 72c:	39 05 34 0a 00 00    	cmp    %eax,0xa34
